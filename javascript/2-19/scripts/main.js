...
var longLongVowels = function(word) {
  ...
  for (var i = 0; i < word.length; i++) {
    ...
    if (
      ...
      vowelArray.indexOf(word.charAt(i)) !== -1
    ) {
...
var vsRockPaperScissors = function(numPlayers) {
  ...
  var check = prompt(
    "This function is not complete, and will loop infinitely, probably messing up your browser. Are you sure you want to run it?"
  );
  if (check === "yes") {
